...
if ($uploadOk == 1) {
  if (isset($_POST['name']) && isset($_POST['brand']) && isset($_POST['category']) && isset($_POST['price']) && isset($_FILES['image']['name']) && isset($_POST['description']) && isset($_POST['feature'])) {
    $product->InsertPD($id+1,$_POST['name'],$_POST['brand'],$_POST['category'],$_POST['price'],$_FILES['image']['name'],$_FILES['image2']['name'],$_FILES['image3']['name'],$_FILES['image4']['name'],$_POST['description'],$_POST['detail'],$_POST['feature']);
  } else {
    $uploadOk = 0;
  }
}
  ...
  ?>
    <div class="popup" id="success">
      <div class="popup-content">
        ...
        <form action="">
          <a href="productaddADM.php" class="button" id="s_button">OKAY</a>
        </form>
      </div>
    </div>
  <?php
  ...
  ?>
    <div class="popup" id="error">
      <div class="popup-content">
        ...
        <form action="">
          <a href="productaddADM.php" class="button" id="e_button">TRY AGAIN</a>
        </form>
      </div>
    </div>
