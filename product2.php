			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<li <?php if (isset($_GET['id'])) {
						...
						}?>><a href="store.php?lm=1>&id=-1">All Categories</a></li>
					<?php
					foreach ($protypes as $key => $value) {
					...
					?>
						...
						}?>><a href="store.php?lm=1&id=<?= $value['type_id'] ?>"><?= $value['type_name'] ?></a></li>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<?php
									echo number_format($getProductById[0]['price']);
								?>
