            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                        foreach ($order->getAllOrder() as $key => $value) {
                            ...
                            ?>
                                ...
                                <td><?=$value['time_ordered']?></td>
                                <td><?=number_format($value['sale_price'] * $value['qty'])?> VND</td>
                                <td> <?=$value['qty']?></td>
                                <td> <input type="checkbox" name="id[]" value="<?=$value['id']?>,<?=$value['user_name']?>" class="order_pd"></td>
                                </tr>
                            <?php
                        }
                    ?>
              ...
              <button type="submit" name="ship" value="ship" class="btn btn-primary">Ship</button>
              <button type="submit" name="delete" value="delete" class="btn btn-danger mt-3 btn_ship"><i class="fa-solid fa-trash-can"></i> Delete</button>
              <!-- /.card-body -->
            </div>
            </form>
            <!-- /.card -->
