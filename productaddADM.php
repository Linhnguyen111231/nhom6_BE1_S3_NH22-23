...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="SEAddProduct.php" method="post" enctype="multipart/form-data">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="price" id="inputProjectLeader" class="form-control">
              </div>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" name="submit" value="Create new Porduct" id="sbm" class="btn btn-success float-right">
        </div>
      </div>
    </section>
    </form>
